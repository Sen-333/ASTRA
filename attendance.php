...
<body>
     <div class="page">
        <div class="header-area">
            <div class="logo-area"> <h2 class="logo">STUDENT ATTENDANCE SYSTEM</h2></div>
            <div class="logout-area"><button class="btnlogout" id="btnLogout">LOGOUT</button>
        ...
        <div class="container">
        <div class="add">
            <button onclick="window.location.href='add.php'">ADD NEW STUDENT</button>
            <button onclick="window.location.href='update.php'">UPDATE STUDENT RECORD</button>
            <button onclick="window.location.href='delete.php'">DELETE STUDENT</button>
        </div>
        </div>
     </div>
